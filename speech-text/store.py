...
class SpeechRecognitionApp:
    def __init__(self, master):
        ...
        self.style.configure("TButton", font=("Helvetica", 12), background="#007bff", foreground="white", padding=10)
    ...
    def create_widgets(self):
        ...
        self.result_label = ttk.Label(self.master, text="", font=("Helvetica", 14), background="#f0f0f0")
        self.result_label.pack(pady=5)
        
        self.status_label = ttk.Label(self.master, text="", font=("Helvetica", 10), background="#f0f0f0")
    ...
    def recognize_speech(self):
        try:
            with sr.Microphone() as source:
                ...
                self.status_label.config(text="Recognizing...", foreground="blue")
