...
image_gamma_corrected = np.clip((image / 255.0) ** gamma * 255.0, 0, 255).astype(np.uint8)

image_gray = cv2.cvtColor(image_gamma_corrected, cv2.COLOR_BGR2GRAY) # converting image into grayscale
